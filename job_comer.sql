...
START TRANSACTION;
USE `job_comer`;
INSERT INTO `job_comer`.`user` (`id`, `username`, `password`, `email`, `name`, `gender`, `birthdate`, `address`, `tel`, `zipcode`, `hobby`, `bahasa`, `warga_negara`, `agama`, `usercol`, `foto`, `role`) VALUES (0, 'admin', 'admin', DEFAULT, DEFAULT, DEFAULT, DEFAULT, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
