...
-- -----------------------------------------------------
-- Table `job_comer`.`email`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `job_comer`.`email` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `job_comer`.`email_company`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `job_comer`.`email_company` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE INDEX `email_UNIQUE` (`email` ASC),
  INDEX `fk_email_company_company1_idx` (`company_id` ASC),
  CONSTRAINT `fk_email_company_company1`
