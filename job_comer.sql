...
INSERT INTO `job_comer`.`user` (`id`, `username`, `password`, `email`, `name`, `gender`, `birthdate`, `foto`, `role`, `address`, `tel`, `zipcode`, `hobby`, `bahasa`, `warga_negara`, `agama`, `about_me`, `activation_token`, `last_activation_request`, `lost_password_request`, `active`, `sign_up_stamp`, `last_sign_in_stamp`) VALUES (2, 'student', '$2y$10$oJ4arK0b/XKjwVFVlJKaVu0FxUVppyU2JPBbbxThugyGwgREi.n6W', 'student@student.com', 'IMMA STUDENT', 'male', '2012-05-05', '2.png', DEFAULT, 'THIS IS MY ADDRESS', '01234156789', '012345', 'I DONT HAVE HOBBY', 'Indonesia', 'Indonesia', 'THIS IS AGAMA', 'I DONT KNOW ANYTHING ABOUT ME', '983653c03db61a918527064ad99a31fd0feae771', '0000-00-00 00:00:00', 0, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
START TRANSACTION;
USE `job_comer`;
INSERT INTO `job_comer`.`company` (`id`, `username`, `password`, `nama`, `email`, `nama_cp`, `tel`, `alamat`, `deskripsi`, `logo`, `activation_token`, `last_activation_request`, `lost_password_request`, `active`, `sign_up_stamp`, `last_sign_in_stamp`) VALUES (1, 'demo', '$2y$10$Ns72yppAiWdZY4elhiRIxOOuMwLIjTIioFHAUtWNvOiKWMLqvYYYy', 'demo', 'demo@demo.com', 'demo cp', '01631854985', 'alamats', '', '0', '123567', '0', 0, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
