...
<head>
    ...
    <title><?php echo getOption("website_name");?> Company</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="http://<?php echo getFolderUrl();?>index.php"><?php echo getOption("website_name");?> Company</a>
		</div>
