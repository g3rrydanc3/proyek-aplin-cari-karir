...
<body style="margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0;font-family:\'Lato\',\'Helvetica Neue\' ,Helvetica,Arial,sans-serif;font-weight: 700;">
		...
		<tbody>
			<tr>
				<td align="center" style="border-collapse: collapse;">
					<a href="http://'. getFolderUrl() .'view_email.php?type=register&key='. $data["activation_token"] .'&email='. $data["email"] .'&name=' . $data["name"] . '" style="color:#59595b;text-decoration:none;"><p>Click here if you can\'t see this email properly.</p></a>
						...
						<tbody>
							<tr>
								...
								<div style="text-align: center; margin-top: 30px !important; margin-bottom: 50px !important;" align="center">
									<a href="http://'. getFolderUrl() .'active.php?active='. $data["activation_token"] .'&email='. $data["email"] .'" style="color:#f1f1f1;background-color:#000000;border-radius:25px;display:inline-block;font-size:14px;letter-spacing:1px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:300px;">CONFIRM EMAIL ADDRESS</a>
								</div>
	...
	function emailRegisterCompany($data){
		global $mail;
		$msg = '
<!DOCTYPE html>
<html lang="en">
...
<body style="margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0;font-family:\'Lato\',\'Helvetica Neue\' ,Helvetica,Arial,sans-serif;font-weight: 700;">
	<table id="body-table" style="border-collapse: collapse; margin-left: 0; margin-top: 0; margin-right: 0; margin-bottom: 0; padding-left: 0; padding-bottom: 0; padding-right: 0; padding-top: 0; background-color: #f8f8f8; height: 100% !important; width: 100% !important;" bgcolor="#f2f2f2">
		<tbody>
			<tr>
				<td align="center" style="border-collapse: collapse;">
					<a href="http://'. getFolderUrl() .'view_email.php?type=registerCompany&key='. $data["activation_token"] .'&email='. $data["email"] .'&name=' . $data["nama"] . '" style="color:#59595b;text-decoration:none;"><p>Click here if you can\'t see this email properly.</p></a>
					<p style="text-align: center; margin-right: 0; margin-top: 30px; margin-bottom: 30px; margin-left: 0;" align="center">
					<a href="http://'. getFolderUrl() .'" style="color:#59595b;text-decoration:none;">
						<h1>Job Comer</h1>
					</a>
					...
					<table style="border-collapse: collapse; margin-top: 0px; width: 600px; background-color: #FFFFFF;" bgcolor="#FFFFFF" width="600">
						<tbody>
							<tr>
								...
								<div style="text-align: center; margin-top: 30px !important; margin-bottom: 50px !important;" align="center">
									<a href="http://'. getFolderUrl() .'company/active.php?active='. $data["activation_token"] .'&email='. $data["email"] .'" style="color:#f1f1f1;background-color:#000000;border-radius:25px;display:inline-block;font-size:14px;letter-spacing:1px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:300px;">CONFIRM EMAIL ADDRESS</a>
								</div>
								<table style="border-collapse: collapse; background-color: #1c4b77; margin-top: 20px !important;" bgcolor="#1c4b77" width="520">
									<tr>
										<td style="border-collapse: collapse; background-color: #f8f8f8; text-align: center;" bgcolor="#f8f8f8">
	...
	function emailForgotPassword($data){
		global $mail;
		$msg = '
<!DOCTYPE html>
<html lang="en">
...
<body style="margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0;font-family:\'Lato\',\'Helvetica Neue\' ,Helvetica,Arial,sans-serif;font-weight: 700;">
	<table id="body-table" style="border-collapse: collapse; margin-left: 0; margin-top: 0; margin-right: 0; margin-bottom: 0; padding-left: 0; padding-bottom: 0; padding-right: 0; padding-top: 0; background-color: #f8f8f8; height: 100% !important; width: 100% !important;" bgcolor="#f2f2f2">
		<tbody>
			<tr>
				<td align="center" style="border-collapse: collapse;">
					<a href="http://'. getFolderUrl() .'view_email.php?type=reset&key='. $data["activation_token"] .'&email='. $data["email"] .'&name=' . $data["name"] . '" style="color:#59595b;text-decoration:none;"><p>Click here if you can\'t see this email properly.</p></a>
					<p style="text-align: center; margin-right: 0; margin-top: 30px; margin-bottom: 30px; margin-left: 0;" align="center">
					<a href="http://'. getFolderUrl() .'" style="color:#59595b;text-decoration:none;">
						<h1>Job Comer</h1>
					</a>
					...
					<table style="border-collapse: collapse; margin-top: 0px; width: 600px; background-color: #FFFFFF;" bgcolor="#FFFFFF" width="600">
						<tbody>
							<tr>
								...
								<div style="text-align: center; margin-top: 30px !important; margin-bottom: 50px !important;" align="center">
									<a href="http://'. getFolderUrl() .'passwordchange.php?key='. $data["activation_token"] .'&email='. $data["email"] .'&role=student" style="color:#f1f1f1;background-color:#000000;border-radius:25px;display:inline-block;font-size:14px;letter-spacing:1px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:300px;">RESET PASSWORD</a>
								</div>
								<table style="border-collapse: collapse; background-color: #1c4b77; margin-top: 20px !important;" bgcolor="#1c4b77" width="520">
									<tr>
										<td style="border-collapse: collapse; background-color: #f8f8f8; text-align: center;" bgcolor="#f8f8f8">
		...
		//$mail->addAttachment('images/phpmailer_mini.png');
		//$mail->AltBody = '<a href='. $link .'>Click here if you can\'t see this email</a>';
		$mail->Subject = "Job Comer - Reset Password";	
		$mail->msgHTML($msg);
		$mail->addAddress($data["email"], $data["name"]);
	...
	function emailForgotPasswordCompany($data){
		global $mail;
		$msg = '
<!DOCTYPE html>
<html lang="en">
...
<body style="margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0;font-family:\'Lato\',\'Helvetica Neue\' ,Helvetica,Arial,sans-serif;font-weight: 700;">
	<table id="body-table" style="border-collapse: collapse; margin-left: 0; margin-top: 0; margin-right: 0; margin-bottom: 0; padding-left: 0; padding-bottom: 0; padding-right: 0; padding-top: 0; background-color: #f8f8f8; height: 100% !important; width: 100% !important;" bgcolor="#f2f2f2">
					...
					<table style="border-collapse: collapse; margin-top: 0px; width: 600px; background-color: #FFFFFF;" bgcolor="#FFFFFF" width="600">
						<tbody>
							<tr>
								...
								<div style="text-align: center; margin-top: 30px !important; margin-bottom: 50px !important;" align="center">
									<a href="http://'. getFolderUrl() .'passwordchange.php?key='. $data["activation_token"] .'&email='. $data["email"] .'&role=company" style="color:#f1f1f1;background-color:#000000;border-radius:25px;display:inline-block;font-size:14px;letter-spacing:1px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:300px;">RESET PASSWORD</a>
								</div>
								<table style="border-collapse: collapse; background-color: #1c4b77; margin-top: 20px !important;" bgcolor="#1c4b77" width="520">
									<tr>
										<td style="border-collapse: collapse; background-color: #f8f8f8; text-align: center;" bgcolor="#f8f8f8">
		...
		//$mail->addAttachment('images/phpmailer_mini.png');
		//$mail->AltBody = '<a href='. $link .'>Click here if you can\'t see this email</a>';
		$mail->Subject = "Job Comer - Reset Password Company";	
		$mail->msgHTML($msg);
		$mail->addAddress($data["email"], $data["name"]);
